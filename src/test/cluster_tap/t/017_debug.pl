...
is( $node->safe_psql(
	...
	'block_format,buffer_format,cluster_cssd,cluster_stats,conf,diag,ges,grd,guc,ic,inject,lck,lms,lmon,pcm,pgstat,phase,scn,shared_fs,shmem',
	'all 20 categories appear (19 prior + lms spec-2.18)');
