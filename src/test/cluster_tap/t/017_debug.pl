...
is( $node->safe_psql(
	...
	'106',
	'all 106 injection points have a .fault_type entry under inject category after spec-2.35');
...
is( $node->safe_psql(
	...
	'106',
	'all 106 injection points have a .hits entry under inject category after spec-2.35');
