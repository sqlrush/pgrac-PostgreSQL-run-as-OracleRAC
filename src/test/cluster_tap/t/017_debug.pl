...
is( $node->safe_psql(
	...
	'123',
	'all 123 injection points have a .fault_type entry under inject category (spec-4.5a +1)');
...
is( $node->safe_psql(
	...
	'123',
	'all 123 injection points have a .hits entry under inject category (spec-4.5a +1)');
