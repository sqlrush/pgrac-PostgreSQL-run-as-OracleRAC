...
#      - It returns exactly 66 rows (one per cluster wait event through
#        spec-2.29 Step 3).
...
is($node->safe_psql('postgres',
	...
	'66',
	'pg_stat_cluster_wait_events returns 66 rows (65 prior + 1 reconfig spec-2.29 D9 ClusterBgProcLmonReconfigTick)');
