...
#      - It returns exactly 69 rows (one per cluster wait event through
#        spec-2.19 D12).
...
is($node->safe_psql('postgres',
	...
	'69',
	'pg_stat_cluster_wait_events returns 69 rows (66 prior + 3 LMD spec-2.19 D12 lifecycle events)');
