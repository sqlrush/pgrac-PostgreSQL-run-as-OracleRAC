...
is( $node->safe_psql('postgres',
	...
	'123',
	'pg_stat_cluster_injections returns 123 rows (spec-4.5a +1 cr_force_read_scn)');
...
is( $node->safe_psql(
	...
	'123 injection point names match the full registry (spec-4.5a +1 cr_force_read_scn)');
