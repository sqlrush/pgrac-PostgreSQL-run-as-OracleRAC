...
is( $node->safe_psql('postgres',
	...
	'110',
	'pg_stat_cluster_injections returns 110 rows after spec-2.36 CF 3-way protocol additions');
...
is( $node->safe_psql(
	...
	'110 injection point names match the full registry after spec-2.36');
