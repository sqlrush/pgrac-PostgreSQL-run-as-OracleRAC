...
-- ----------
-- 3. pg_tablespace_location(9100) returns 'pg_undo' relative path.
--    D14b special case -- without it the call would readlink()
--    pg_tblspc/9100 which doesn't exist and raise an error.
-- ----------
