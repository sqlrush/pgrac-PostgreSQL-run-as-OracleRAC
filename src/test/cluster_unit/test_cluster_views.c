...
UT_TEST(test_cluster_wait_events_count_is_98)
{
	/*
	 ...
	 */
	UT_ASSERT_EQ(CLUSTER_WAIT_EVENTS_COUNT, 98);
}
...
{
	UT_PLAN(4);
	UT_RUN(test_cluster_wait_events_count_is_98);
